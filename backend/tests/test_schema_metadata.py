...
from app.db.models import APIKey, DumpIndex, ModelMap, RequestAttemptLog, RequestLog
...
def test_dump_index_indexes_are_declared() -> None:
    names = {index.name for index in DumpIndex.__table__.indexes}
